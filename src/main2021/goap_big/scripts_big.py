...
def GOAP_script(req):
    ...
    if req.emergency == False and counter_scripts == 0: #blue team script
        ...
        scrpit_mission =[38,13,
        12,12,
        39,14,
        12,12,12,12,
        45,
        9,18,19,20,#place front side back
        21,22,23,
        5
        # 14,
        ...
        position_script=[
          # [req.my_pos[0],req.my_pos[1],req.my_pos[2]],
             [596.872, 2759.329, -2.403962],[357.9697626, 2501.356, -2.303962],
            current.cup_state[20]['robot_pos'],  current.cup_state[19]['robot_pos'],
            [973.036, 2749.5813,2.610415466],#before mission 14 
             [1483.036 ,2419.246645, 2.58],#mission 14
             current.cup_state[16]['robot_pos'], #cup 16 +
             current.cup_state[15]['robot_pos'], #cup 15 -
             current.cup_state[10]['robot_pos'], #cup 10 x
             current.cup_state[9]['robot_pos'], #cup 9 -
            [1471.41550269, 1210.9632466,0.02], #放杯前的點
             [1738.03586831, 1207.28766048,0.0], #pla0ce 4cup
             [1688.03586831, 1207.28766048,0.0], #pla0ce 2cup
             [1538.03586831, 1207.28766048,0.0], #back off
             [1538.03586831, 1207.28766048,math.pi], #turn around
             [1638.03586831, 1207.28766048,math.pi], #pla0ce 4cup
             [1568.03586831, 1207.28766048,math.pi], #pla0ce 2cup
             [1378.03586831, 1207.28766048,math.pi], #back off
            [331.684992696, 2505.45267953, 2.0756502662], #go home yeah~

            # [1450,2227.334,-0.7354],[1289.3864,2480.9923,-0.7178]
