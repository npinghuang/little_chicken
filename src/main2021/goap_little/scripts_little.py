  ...
  if req.emergency == False and counter_scripts == 0: #blue team script
    ...
    position_script = [ 
      # 1085, 2805,math.pi,#back away
       550, 2840,math.pi,#back away

      
      1750,2840,math.pi, #first point of windsock

      1850,2840,-math.pi/2, #first point of windsock
      1850,2955,-math.pi/2, # move backward prepare to accelerate for windsock
      1870,2240,-math.pi/2,#second point of windsock retrieve hand
      1870,2240,math.pi,#second point of windsock retrieve hand

      1615,2240,math.pi/2,#before reef private
      1615,2850,math.pi/2,#before reef private

      1615,2995,math.pi/2,#getcup
      1615,2820,0,#after reef private
      # 10
      942,2820,-0.05,#place green cup
      375,2820,0,#place red cup
      200,2820,0,#back off  13

      200, 2820,(math.pi-0.1), #move forward a little bit before lighthouse
...
# 20
      ...
      250,2420,math.pi/2,#move backward
      200,2810,0,#move backward 
