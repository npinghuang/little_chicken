...
ros::Time now_time;
float doing_time;
float wait_sec = 4.0; //wait for big chicken 10.0
...
std::vector<int> reefp_color{0,1,0,1,0};
...
//   }
    ...
    if (msg->emerg == 1){
        ...
        switch (msg->action)
        {
            ...
            //     //   state_mission = success;
            //       break;
            case 11: // placecup_r for 0418 demo red first
            ...
            //   state_mission = success;
                break;
            case 45: // placecup_r green first
                ROS_INFO("placecup count %d", placecup_r.count);
                if ( state_planer == 1 ){
                    switch ( placecup_r.count )
                    {
...
int main(int argc, char **argv)
{
    ...
    for_ST2_little.data = {1,1,1,1,1,1,2,2,1,0};
    ST2_little_tx = {1,1,1,1,1,1,2,2,1,0};
    forST2_little.publish(for_ST2_little);
